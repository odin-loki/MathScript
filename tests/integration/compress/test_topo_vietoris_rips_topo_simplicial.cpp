...
TEST(IntegrationCompress,  TopoCountsCompressDecode) {
    Interpreter interp;
    expect_contains(interp, "help", "topo_simplicial_counts");
    expect_contains(interp, "help", "huffman_decode_vec");
    expect_contains(interp, "help", "ans_decode_vec");
    expect_contains(interp, "help", "arithmetic_decode_vec");
...
TEST(IntegrationCompress,  Hypergeo0f1Scalar) {
    Interpreter interp;
