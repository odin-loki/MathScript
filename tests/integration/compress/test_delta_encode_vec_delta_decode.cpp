...
TEST(IntegrationCompress,  DeltaLzwEncodeDecode) {
    Interpreter interp;
    expect_contains(interp, "help", "delta_encode_vec");
    expect_contains(interp, "help", "lzw_encode_vec");
    expect_contains(interp, "help", "lzw_decode_vec");
...
TEST(IntegrationCompress, ProbTCdfScalar_DeltaEncodeVecDeltaDecode) {
    Interpreter interp;
