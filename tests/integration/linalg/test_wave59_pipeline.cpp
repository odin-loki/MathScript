...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Geo_Topo_VietorisRips) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Graph_Numthy_ShortestPathCount) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Tensorops_ML_EinsumToPCA) {
...
TEST(IntegrationLinalg,  Tensorops_ML_EinsumToKMeans) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Diffgeo_SurfaceCurvaturesFinite) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Control_Quantum_SmokeFinite) {
