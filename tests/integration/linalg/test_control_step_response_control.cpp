...
TEST(IntegrationLinalg,  ControlImpulseResponse) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  BidiagAssignAndMulti) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  SolveSylvester) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  Hessenberg) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  ComboBinomial) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  GeoBezierEval) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  NumthyFactor) {
    Interpreter interp;
