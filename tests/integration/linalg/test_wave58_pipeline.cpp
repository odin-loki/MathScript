...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Control_Graph_StateFlowPath) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Cplx_Quantum_MobiusRotationPhase) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Finance_Stats_CallReturnsSharpe) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Graph_Control_NetworkToTransferFunction) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Quantum_Info_AmplitudeEntropy) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationLinalg,  Cplx_ContourIntegralFinite) {
