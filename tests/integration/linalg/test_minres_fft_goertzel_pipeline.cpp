...
TEST(IntegrationLinalg,  FftGoertzel) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  StatsVif) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  Fftfreq) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  Ifftshift) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  ComboEulerian) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  ComboGrayCode) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  NumthyFactorExp) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  NumthyIsCarmichael) {
    Interpreter interp;
...
TEST(IntegrationLinalg,  StatsWeightedVariance) {
    Interpreter interp;
