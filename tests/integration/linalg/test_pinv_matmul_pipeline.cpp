...
TEST(IntegrationLinalg,  PinvNullOrthKron) {
    Interpreter interp;
    expect_contains(interp, "help", "pinv");
    expect_contains(interp, "help", "null");
    expect_contains(interp, "help", "orth");
    expect_contains(interp, "help", "kron");
...
TEST(IntegrationLinalg, CplxJoukowskiInvScalar_PinvMatmulPipeline) {
    Interpreter interp;
