...
// ---------------------------------------------------------------------------
TEST(IntegrationImage,  Image_RGB2Gray_Sobel_Canny) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationImage,  ML_PCA_OnImagePatches) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationImage,  ML_KMeans_OnSobelPatches) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationImage,  Compress_RLE_Huffman_FeatureRoundtrip) {
...
// ---------------------------------------------------------------------------
TEST(IntegrationImage,  Bignum_BinomialMatchesCombo) {
