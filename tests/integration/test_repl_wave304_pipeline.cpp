// MathScript Integration Tests: REPL Interpreter – Wave 304 Pipeline
//
// Wave 304 REPL smoke: geo tail11 extensions, Struve/Anger/Weber scalar validation.
...
TEST(ReplWave304Pipeline, StruveScalar) {
    Interpreter interp;
