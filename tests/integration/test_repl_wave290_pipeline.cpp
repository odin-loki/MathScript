// MathScript Integration Tests: REPL Interpreter – Wave 290 Pipeline
//
// Wave 290 REPL smoke: image/topo/stats tail11 extensions, chebyshev_v/chebyshev_w scalar.
...
TEST(ReplWave290Pipeline, ImageTopoStats) {
    Interpreter interp;
...
TEST(ReplWave290Pipeline, SpecialScalar) {
    Interpreter interp;
