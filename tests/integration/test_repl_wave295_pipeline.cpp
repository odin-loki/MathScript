// MathScript Integration Tests: REPL Interpreter – Wave 295 Pipeline
//
// Wave 295 REPL smoke: linalg/combo tail11 extensions, chebyshev_tn/un scalar.
...
TEST(ReplWave295Pipeline, LinalgCombo) {
    Interpreter interp;
...
TEST(ReplWave295Pipeline, SpecialScalar) {
    Interpreter interp;
