// MathScript Integration Tests: REPL Interpreter – Wave 284 Pipeline
//
// Wave 284 REPL smoke: PDE/control/signal/ODE tail11 extensions, ellip_k scalar.
...
TEST(ReplWave284Pipeline, PdeControl) {
    Interpreter interp;
...
TEST(ReplWave284Pipeline, SignalOdeSpecial) {
    Interpreter interp;
