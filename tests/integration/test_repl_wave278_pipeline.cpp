// MathScript Integration Tests: REPL Interpreter – Wave 278 Pipeline
//
// Wave 278 REPL smoke: token bucket introspection, crypto bytes-to-hex,
// BWT decode assign, 2D FEM/CFD tail11, quantum_schrodinger trajectory,
// run_backtest_equity.
...
TEST(ReplWave278Pipeline, TokenCryptoBwt) {
    Interpreter interp;
...
TEST(ReplWave278Pipeline, FemCfdQuantum2d) {
    Interpreter interp;
