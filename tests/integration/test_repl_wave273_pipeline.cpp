// MathScript Integration Tests: REPL Interpreter – Wave 273 Pipeline
//
// Wave 273 REPL smoke: izaac VRF prove/verify, encrypt/decrypt, randn; quantum Schmidt number,
// ket tensor product, outer; Cypha NIG moments; special theta functions; CFD 3D advection.
...
TEST(ReplWave273Pipeline, IzaacVrfCrypto) {
    Interpreter interp;
...
TEST(ReplWave273Pipeline, QuantumCyphaSpecial) {
    Interpreter interp;
...
TEST(ReplWave273Pipeline, CfdAdvection3d) {
    Interpreter interp;
