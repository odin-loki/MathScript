// MathScript Integration Tests: REPL Interpreter – Wave 285 Pipeline
//
// Wave 285 REPL smoke: control/signal/ODE tail11 extensions, legendre_p scalar.
...
TEST(ReplWave285Pipeline, ControlSignal) {
    Interpreter interp;
...
TEST(ReplWave285Pipeline, OdeSpecial) {
    Interpreter interp;
