// MathScript Integration Tests: REPL Interpreter – Wave 294 Pipeline
//
// Wave 294 REPL smoke: linalg/geo tail11 extensions, laguerre_ln scalar.
...
TEST(ReplWave294Pipeline, LinalgGeo) {
    Interpreter interp;
...
TEST(ReplWave294Pipeline, SpecialScalar) {
    Interpreter interp;
