// MathScript Integration Tests: REPL Interpreter – Wave 298 Pipeline
//
// Wave 298 REPL smoke: numthy/poly/graph tail11 extensions, special_falling_factorial scalar.
...
TEST(ReplWave298Pipeline, NumthyPolyGraph) {
    Interpreter interp;
...
TEST(ReplWave298Pipeline, SpecialScalar) {
    Interpreter interp;
