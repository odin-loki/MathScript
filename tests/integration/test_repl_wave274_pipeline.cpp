// MathScript Integration Tests: REPL Interpreter – Wave 274 Pipeline
//
// Wave 274 REPL smoke: FEM 1D composable, CFD 1D/2D composable advection, quantum dagger/matmul,
// Schmidt bases, izaac rand matrix, Lagrange eval.
...
TEST(ReplWave274Pipeline, Fem1dComposable) {
    Interpreter interp;
...
TEST(ReplWave274Pipeline, CfdComposableAdvection) {
    Interpreter interp;
...
TEST(ReplWave274Pipeline, QuantumIzaac) {
    Interpreter interp;
