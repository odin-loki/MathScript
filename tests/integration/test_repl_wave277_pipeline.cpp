// MathScript Integration Tests: REPL Interpreter – Wave 277 Pipeline
//
// Wave 277 REPL smoke: crypto from_hex, bloom introspection, topo simplicial
// counts/dimension, compress decode assign forms, 3D FEM/CFD tail11 composable
// pipeline, quantum_schrodinger_final.
...
TEST(ReplWave277Pipeline, CryptoBloomTopoCompress) {
    Interpreter interp;
...
TEST(ReplWave277Pipeline, FemCfdQuantum3d) {
    Interpreter interp;
