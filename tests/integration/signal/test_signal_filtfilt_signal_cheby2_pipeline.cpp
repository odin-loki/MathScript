...
TEST(IntegrationSignal,  SignalFiltfiltBinding) {
    Interpreter interp;
...
TEST(IntegrationSignal,  SignalFiltfiltViaCheby2) {
    Interpreter interp;
...
TEST(IntegrationSignal,  Wave249CryptoSha256Smoke) {
    Interpreter interp;
...
TEST(IntegrationSignal,  Wave249CudaReduceSmoke) {
    Interpreter interp;
