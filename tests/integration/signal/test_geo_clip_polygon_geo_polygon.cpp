...
TEST(IntegrationSignal,  GeoClipPolygonBinding) {
    Interpreter interp;
...
TEST(IntegrationSignal,  SignalUpsampleBinding) {
    Interpreter interp;
...
TEST(IntegrationSignal,  SignalDownsampleBinding) {
    Interpreter interp;
...
TEST(IntegrationSignal,  UpsampleDownsampleRoundTrip) {
    Interpreter interp;
