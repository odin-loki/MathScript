...
TEST(IntegrationSignal,  SignalCztDftContour) {
    Interpreter interp;
...
TEST(IntegrationSignal,  SignalCztZoomSmoke) {
    Interpreter interp;
...
TEST(IntegrationSignal,  Wave253SignalConv2OrMedianSmoke) {
    Interpreter interp;
...
TEST(IntegrationSignal,  Wave253CryptoAes128DecryptSmoke) {
    Interpreter interp;
...
TEST(IntegrationSignal,  Wave253CudaAllgatherAssignmentSmoke) {
    Interpreter interp;
