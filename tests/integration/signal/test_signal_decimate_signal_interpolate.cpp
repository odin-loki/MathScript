...
TEST(IntegrationSignal,  SignalDecimateBinding) {
    Interpreter interp;
...
TEST(IntegrationSignal,  SignalInterpolateBinding) {
    Interpreter interp;
...
TEST(IntegrationSignal,  SignalResampleBinding) {
    Interpreter interp;
...
TEST(IntegrationSignal,  Wave248CryptoConstantTimeEqSmoke) {
    Interpreter interp;
...
TEST(IntegrationSignal,  Wave248CudaBroadcastSmoke) {
    Interpreter interp;
...
TEST(IntegrationSignal,  Wave248GeoClipPolygonSmoke) {
    Interpreter interp;
