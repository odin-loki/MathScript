...
TEST(IntegrationFem,  FemPoisson3dBinding) {
    Interpreter interp;
...
TEST(IntegrationFem,  CryptoX25519SharedBinding) {
    Interpreter interp;
...
TEST(IntegrationFem,  DistMatmulBinding) {
    Interpreter interp;
...
TEST(IntegrationFem,  CfdAdvection3dBinding) {
    Interpreter interp;
