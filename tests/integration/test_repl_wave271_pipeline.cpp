// MathScript Integration Tests: REPL Interpreter – Wave 271 Pipeline
//
// Wave 271 REPL smoke: FEM/CFD 3D primitives, Weierstrass zeta/sigma, Jacobi ratios,
// GRIA gf2n field, quantum eigenspectrum/ground_state.
//
// Covered: fem_mesh3d_box, fem_stiffness_3d, cfd_grid3d, cfd_square_pulse_3d,
// weierstrass_zeta, jacobi_nd, gria_gf2n_generate_field, quantum_eigenspectrum,
// quantum_ground_state, fem_poisson3d, cfd_advection3d.
...
TEST(ReplWave271Pipeline, Fem3dAssembly) {
    Interpreter interp;
...
TEST(ReplWave271Pipeline, Cfd3dPrimitives) {
    Interpreter interp;
...
TEST(ReplWave271Pipeline, SpecialWeierstrassZeta) {
    Interpreter interp;
...
TEST(ReplWave271Pipeline, GriaGf2nField) {
    Interpreter interp;
...
TEST(ReplWave271Pipeline, QuantumSpectrum) {
    Interpreter interp;
...
TEST(ReplWave271Pipeline, CrossWave236Smoke) {
    Interpreter interp;
