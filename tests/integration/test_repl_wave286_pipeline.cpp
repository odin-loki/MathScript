// MathScript Integration Tests: REPL Interpreter – Wave 286 Pipeline
//
// Wave 286 REPL smoke: FFT/control/signal/ODE tail11 extensions, legendre_q scalar.
...
TEST(ReplWave286Pipeline, FftControl) {
    Interpreter interp;
...
TEST(ReplWave286Pipeline, SignalOdeSpecial) {
    Interpreter interp;
