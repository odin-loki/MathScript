...
TEST(IntegrationFinance,  FinanceEfficientFrontier) {
    Interpreter interp;
...
TEST(IntegrationFinance,  FinanceMaxSharpe) {
    Interpreter interp;
...
TEST(IntegrationFinance,  SqrtmDiagonal) {
    Interpreter interp;
...
TEST(IntegrationFinance,  TrilExtract) {
    Interpreter interp;
...
TEST(IntegrationFinance,  ImtophatPeak) {
    Interpreter interp;
...
TEST(IntegrationFinance,  ImhistBins) {
    Interpreter interp;
...
TEST(IntegrationFinance,  GraphDijkstra) {
    Interpreter interp;
...
TEST(IntegrationFinance,  InfoPermutationEntropy) {
    Interpreter interp;
