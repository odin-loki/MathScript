...
TEST(IntegrationFinance,  ComboDyckPathsSmoke) {
    Interpreter interp;
...
TEST(IntegrationFinance,  ComboGrayCodeSmoke) {
    Interpreter interp;
...
TEST(IntegrationFinance,  ComboMotzkinPaths) {
    Interpreter interp;
...
TEST(IntegrationFinance,  ComboSetPartitions) {
    Interpreter interp;
...
TEST(IntegrationFinance,  EigSmoke) {
    Interpreter interp;
...
TEST(IntegrationFinance,  BachelierCall) {
    Interpreter interp;
...
TEST(IntegrationFinance,  BachelierPut) {
    Interpreter interp;
...
TEST(IntegrationFinance,  VasicekBondPrice) {
    Interpreter interp;
...
TEST(IntegrationFinance,  CirBondPrice) {
    Interpreter interp;
...
TEST(IntegrationFinance,  TrinomialOption) {
    Interpreter interp;
...
TEST(IntegrationFinance,  PolyResultantSharedRoot) {
    Interpreter interp;
...
TEST(IntegrationFinance,  PolyDiscriminantRepeatedRoot) {
    Interpreter interp;
...
TEST(IntegrationFinance,  Minres) {
    Interpreter interp;
...
TEST(IntegrationFinance,  Fftfreq) {
    Interpreter interp;
...
TEST(IntegrationFinance,  ComboNecklaces) {
    Interpreter interp;
...
TEST(IntegrationFinance,  NumthySternBrocot) {
    Interpreter interp;
...
TEST(IntegrationFinance,  FinanceBachelierCall) {
    Interpreter interp;
