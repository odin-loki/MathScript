// MathScript Integration Tests: REPL Interpreter – Wave 63–105 Bindings Pipeline
...
TEST(ReplWave105Pipeline, Wave63_105_BindingsPipeline) {
    Interpreter interp;
