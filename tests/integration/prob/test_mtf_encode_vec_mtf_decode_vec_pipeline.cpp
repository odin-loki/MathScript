...
TEST(IntegrationProb,  MtfBwtEncode) {
    Interpreter interp;
    expect_contains(interp, "help", "mtf_encode_vec");
    expect_contains(interp, "help", "bwt_encode_vec");
    expect_contains(interp, "help", "mtf_decode_vec");
...
TEST(IntegrationProb,  ProbChi2CdfScalar) {
    Interpreter interp;
