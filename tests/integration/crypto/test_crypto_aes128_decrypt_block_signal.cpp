...
TEST(IntegrationCrypto,  CryptoAes128EncryptDecryptRoundTrip) {
    Interpreter interp;
...
TEST(IntegrationCrypto,  Wave252SignalSosfiltSmoke) {
    Interpreter interp;
...
TEST(IntegrationCrypto,  Wave252CryptoAes256DecryptSmoke) {
    Interpreter interp;
...
TEST(IntegrationCrypto,  Wave252MpiBarrierSmoke) {
    Interpreter interp;
