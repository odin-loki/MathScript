...
TEST(IntegrationCrypto,  CryptoAes256EncryptBlock) {
    Interpreter interp;
...
TEST(IntegrationCrypto,  Wave250CryptoSha512Smoke) {
    Interpreter interp;
...
TEST(IntegrationCrypto,  Wave250CudaNcclCommSizeSmoke) {
    Interpreter interp;
...
TEST(IntegrationCrypto,  Wave250SignalFiltfiltSmoke) {
    Interpreter interp;
