...
TEST(IntegrationCrypto,  CryptoAes256EncryptDecryptRoundTrip) {
    Interpreter interp;
...
TEST(IntegrationCrypto,  Wave251CryptoAes256EncryptSmoke) {
    Interpreter interp;
...
TEST(IntegrationCrypto,  Wave251MpiAllreduceMaxSmoke) {
    Interpreter interp;
...
TEST(IntegrationCrypto,  Wave251GeoConvexHullSmoke) {
    Interpreter interp;
...
TEST(IntegrationCrypto,  Wave251SignalFilterSmoke) {
    Interpreter interp;
