...
TEST(IntegrationCombo,  ComboBracelets) {
    Interpreter interp;
...
TEST(IntegrationCombo,  ComboLyndonWords) {
    Interpreter interp;
...
TEST(IntegrationCombo,  ComboRestrictedPartitions) {
    Interpreter interp;
...
TEST(IntegrationCombo,  ComboInvolutions) {
    Interpreter interp;
...
TEST(IntegrationCombo,  NumthyPellSolve) {
    Interpreter interp;
...
TEST(IntegrationCombo,  NumthyQuadraticResidues) {
    Interpreter interp;
...
TEST(IntegrationCombo,  PolyLagrange) {
    Interpreter interp;
...
TEST(IntegrationCombo,  PolyInterpNewton) {
    Interpreter interp;
...
TEST(IntegrationCombo,  FinanceBlImpliedReturns) {
    Interpreter interp;
...
TEST(IntegrationCombo,  FinanceMertonDistanceToDefault) {
    Interpreter interp;
...
TEST(IntegrationCombo,  FinanceHistoricalVar) {
    Interpreter interp;
...
TEST(IntegrationCombo,  ControlKalmanPredict) {
    Interpreter interp;
...
TEST(IntegrationCombo,  ControlKalmanUpdate) {
    Interpreter interp;
...
TEST(IntegrationCombo,  SpecialVoigt) {
    Interpreter interp;
...
TEST(IntegrationCombo,  SpecialAiryAi) {
    Interpreter interp;
...
TEST(IntegrationCombo,  ComboNecklacesRegression) {
    Interpreter interp;
...
TEST(IntegrationCombo,  NumthySternBrocotRegression) {
    Interpreter interp;
