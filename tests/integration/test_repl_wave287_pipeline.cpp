// MathScript Integration Tests: REPL Interpreter – Wave 287 Pipeline
//
// Wave 287 REPL smoke: graph/image/poly tail11 extensions, hermite_h scalar.
...
TEST(ReplWave287Pipeline, GraphImagePoly) {
    Interpreter interp;
...
TEST(ReplWave287Pipeline, SpecialScalar) {
    Interpreter interp;
