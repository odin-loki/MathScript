// MathScript Integration Tests: REPL Interpreter – Wave 283 Pipeline
//
// Wave 283 REPL smoke: PDE/sparse/control/signal tail11 extensions,
// scalar struve_h/kelvin_ber/jacobi_sn eval fixes.
...
TEST(ReplWave283Pipeline, PdeSparseControl) {
    Interpreter interp;
...
TEST(ReplWave283Pipeline, OdeSignalSpecial) {
    Interpreter interp;
