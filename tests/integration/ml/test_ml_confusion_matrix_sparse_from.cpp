...
TEST(IntegrationMl,  MlConfusionMatrix) {
    Interpreter interp;
...
TEST(IntegrationMl,  SparseFromCoo) {
    Interpreter interp;
...
TEST(IntegrationMl,  GolombRiceEncodeVec) {
    Interpreter interp;
...
TEST(IntegrationMl,  FemPoisson1d) {
    Interpreter interp;
