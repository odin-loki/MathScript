// MathScript Integration Tests: REPL Interpreter – Wave 293 Pipeline
//
// Wave 293 REPL smoke: quantum/izaac tail11 extensions, laguerre_la scalar.
...
TEST(ReplWave293Pipeline, QuantumIzaac) {
    Interpreter interp;
...
TEST(ReplWave293Pipeline, SpecialScalar) {
    Interpreter interp;
