...
TEST(IntegrationPoly,  PolyRoots) {
    Interpreter interp;
...
TEST(IntegrationPoly,  PolyInterpHermite) {
    Interpreter interp;
...
TEST(IntegrationPoly,  PolySquarefree) {
    Interpreter interp;
...
TEST(IntegrationPoly,  NumthyCornacchia) {
    Interpreter interp;
...
TEST(IntegrationPoly,  FinanceTreynor) {
    Interpreter interp;
...
TEST(IntegrationPoly,  FinanceInformationRatio) {
    Interpreter interp;
...
TEST(IntegrationPoly,  ControlCtrb) {
    Interpreter interp;
...
TEST(IntegrationPoly,  ControlObsv) {
    Interpreter interp;
...
TEST(IntegrationPoly,  ControlTf2ss) {
    Interpreter interp;
...
TEST(IntegrationPoly,  ControlC2d) {
    Interpreter interp;
...
TEST(IntegrationPoly,  SpecialAiryBi) {
    Interpreter interp;
...
TEST(IntegrationPoly,  SpecialBesselY) {
    Interpreter interp;
...
TEST(IntegrationPoly,  SpecialLambertW) {
    Interpreter interp;
...
TEST(IntegrationPoly,  SpecialKummerU) {
    Interpreter interp;
...
TEST(IntegrationPoly,  InfoChannelCapacity) {
    Interpreter interp;
...
TEST(IntegrationPoly,  InfoBlahutArimoto) {
    Interpreter interp;
...
TEST(IntegrationPoly,  ComboBraceletsRegression) {
    Interpreter interp;
...
TEST(IntegrationPoly,  NumthyPellSolveRegression) {
    Interpreter interp;
...
TEST(IntegrationPoly,  PolyLagrangeRegression) {
    Interpreter interp;
...
TEST(IntegrationPoly,  FinanceHistoricalVarRegression) {
    Interpreter interp;
...
TEST(IntegrationPoly,  ControlKalmanPredictRegression) {
    Interpreter interp;
...
TEST(IntegrationPoly,  SpecialAiryAiRegression) {
    Interpreter interp;
