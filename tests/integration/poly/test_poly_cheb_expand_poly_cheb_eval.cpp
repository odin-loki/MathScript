...
TEST(IntegrationPoly,  PolyChebExpand) {
    Interpreter interp;
...
TEST(IntegrationPoly,  ControlC2dTustin) {
    Interpreter interp;
...
TEST(IntegrationPoly,  SpecialErfi) {
    Interpreter interp;
...
TEST(IntegrationPoly,  ProbChi2Ppf) {
    Interpreter interp;
...
TEST(IntegrationPoly,  GraphMinArborescence) {
    Interpreter interp;
...
TEST(IntegrationPoly,  ImageSobelX) {
    Interpreter interp;
...
TEST(IntegrationPoly,  StatsKsNorm) {
    Interpreter interp;
...
TEST(IntegrationPoly,  PolyShiftRegression) {
    Interpreter interp;
...
TEST(IntegrationPoly,  ControlSeriesRegression) {
    Interpreter interp;
...
TEST(IntegrationPoly,  BesselKRegression) {
    Interpreter interp;
...
TEST(IntegrationPoly,  InfoNormalizedEntropyRegression) {
    Interpreter interp;
