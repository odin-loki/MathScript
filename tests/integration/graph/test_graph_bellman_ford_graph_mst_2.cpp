...
TEST(IntegrationGraph,  BellmanMstTail15) {
    Interpreter interp;
    expect_contains(interp, "help", "graph_bellman_ford");
    expect_contains(interp, "help", "graph_mst_kruskal");
    expect_contains(interp, "help", "graph_mst_prim");
