...
TEST(IntegrationPde,  PdeAdvectionLaxWendroff) {
    Interpreter interp;
...
TEST(IntegrationPde,  PdeReactionDiffusion1d) {
    Interpreter interp;
...
TEST(IntegrationPde,  OdeRk23Regression) {
    Interpreter interp;
...
TEST(IntegrationPde,  StatsMaxValueRegression) {
    Interpreter interp;
