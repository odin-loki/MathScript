// MathScript Integration Tests: REPL Interpreter – Wave 63–135 Bindings Pipeline
...
TEST(ReplWave135Pipeline, Wave63_135_BindingsPipeline) {
    Interpreter interp;
    ...
    // --- Wave 135 REPL bindings (single session) ---
