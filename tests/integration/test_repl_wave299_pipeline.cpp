// MathScript Integration Tests: REPL Interpreter – Wave 299 Pipeline
//
// Wave 299 REPL smoke: combo/poly tail11 extensions, special_polygamma scalar.
...
TEST(ReplWave299Pipeline, ComboPoly) {
    Interpreter interp;
...
TEST(ReplWave299Pipeline, SpecialScalar) {
    Interpreter interp;
