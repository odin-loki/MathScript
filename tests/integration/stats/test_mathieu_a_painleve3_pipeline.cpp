...
TEST(IntegrationStats,  SpecialMathieuA) {
    Interpreter interp;
...
TEST(IntegrationStats,  SpecialPainleve3) {
    Interpreter interp;
...
TEST(IntegrationStats,  MlPcaFit) {
    Interpreter interp;
...
TEST(IntegrationStats,  GeoUpperHull) {
    Interpreter interp;
...
TEST(IntegrationStats,  StatsMaxValue) {
    Interpreter interp;
...
TEST(IntegrationStats,  PolyChebExpandRegression) {
    Interpreter interp;
...
TEST(IntegrationStats,  SpecialErfiRegression) {
    Interpreter interp;
...
TEST(IntegrationStats,  StatsKsNormRegression) {
    Interpreter interp;
