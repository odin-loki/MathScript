...
TEST(IntegrationStats,  StatsLinearRegression) {
    Interpreter interp;
...
TEST(IntegrationStats,  StatsBootstrapCi) {
    Interpreter interp;
...
TEST(IntegrationStats,  GraphModularity) {
    Interpreter interp;
...
TEST(IntegrationStats,  GraphEccentricity) {
    Interpreter interp;
...
TEST(IntegrationStats,  GeoKdtree3dNearest) {
    Interpreter interp;
...
TEST(IntegrationStats,  GeoDistPointPlane) {
    Interpreter interp;
...
TEST(IntegrationStats,  ImflipHorizontal) {
    Interpreter interp;
