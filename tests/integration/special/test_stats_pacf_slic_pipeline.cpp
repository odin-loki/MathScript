...
TEST(IntegrationSpecial,  PacfSlicTail16) {
    Interpreter interp;
    expect_contains(interp, "help", "stats_pacf");
    expect_contains(interp, "help", "slic");
...
TEST(IntegrationSpecial, JacobiDnScalar_StatsPacfSlicPipeline) {
    Interpreter interp;
