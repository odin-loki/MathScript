...
TEST(IntegrationSpecial,  Kmeans) {
    Interpreter interp;
    expect_contains(interp, "help", "ml_kmeans_fit");
    expect_contains(interp, "help", "ml_kmeans_predict");
...
TEST(IntegrationSpecial, JacobiNsScalar_MlKmeansFitMlKmeansPredict) {
    Interpreter interp;
