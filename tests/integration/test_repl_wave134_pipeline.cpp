// MathScript Integration Tests: REPL Interpreter – Wave 63–134 Bindings Pipeline
...
TEST(ReplWave134Pipeline, Wave63_134_BindingsPipeline) {
    Interpreter interp;
    ...
    // --- Wave 134 REPL bindings (single session) ---
