...
TEST(IntegrationFrameworks, CellaiBoltzmannCypha_CellaiBoltzmannWeightsCellmemory3) {
    Interpreter interp;
...
TEST(IntegrationFrameworks, BesselZeroYnuScalar_CellaiBoltzmannWeightsCellmemory3) {
    Interpreter interp;
