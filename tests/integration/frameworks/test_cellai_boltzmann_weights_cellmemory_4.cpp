...
TEST(IntegrationFrameworks, CellaiBoltzmannCypha_CellaiBoltzmannWeightsCellmemory4) {
    Interpreter interp;
...
TEST(IntegrationFrameworks, BesselZeroYnuScalar_CellaiBoltzmannWeightsCellmemory4) {
    Interpreter interp;
