...
TEST(IntegrationGeo,  GeoMinkowskiSumBinding) {
    Interpreter interp;
...
TEST(IntegrationGeo,  GeoMinBoundingRectBinding) {
    Interpreter interp;
...
TEST(IntegrationGeo,  SignalUnwrapBinding) {
    Interpreter interp;
...
TEST(IntegrationGeo,  DistLsmrSquareSystem) {
    Interpreter interp;
...
TEST(IntegrationGeo,  GraphMaximumMatchingBinding) {
    Interpreter interp;
...
TEST(IntegrationGeo,  CudaAllreduceProdStub) {
    Interpreter interp;
...
TEST(IntegrationGeo,  CryptoAes256GcmRoundTrip) {
    Interpreter interp;
