...
TEST(IntegrationGeo,  GeoPointInAabbSmoke) {
    Interpreter interp;
...
TEST(IntegrationGeo,  GeoOverlapAabbSmoke) {
    Interpreter interp;
...
TEST(IntegrationGeo,  SignalCztDftContour) {
    Interpreter interp;
...
TEST(IntegrationGeo,  SignalDeconvSmoke) {
    Interpreter interp;
