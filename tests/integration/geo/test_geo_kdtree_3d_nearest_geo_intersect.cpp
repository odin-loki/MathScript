...
TEST(IntegrationGeo,  GeoKdtree3dNearest) {
    Interpreter interp;
...
TEST(IntegrationGeo,  GeoIntersectRayTri) {
    Interpreter interp;
...
TEST(IntegrationGeo,  GeoDistPointPlane) {
    Interpreter interp;
...
TEST(IntegrationGeo,  GeoKdtreeKnnSmoke) {
    Interpreter interp;
...
TEST(IntegrationGeo,  GeoTriangulatePolygonSmoke) {
    Interpreter interp;
...
TEST(IntegrationGeo,  GraphSpectralSmoke) {
    Interpreter interp;
