// MathScript Integration Tests: REPL Interpreter – Wave 303 Pipeline
//
// Wave 303 REPL smoke: finance tail11 extensions, extended Bessel scalar validation.
...
TEST(ReplWave303Pipeline, Finance) {
    Interpreter interp;
...
TEST(ReplWave303Pipeline, BesselScalar) {
    Interpreter interp;
