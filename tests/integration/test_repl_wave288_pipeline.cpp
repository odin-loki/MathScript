// MathScript Integration Tests: REPL Interpreter – Wave 288 Pipeline
//
// Wave 288 REPL smoke: graph/stats/geo/image tail11 extensions, laguerre_l/chebyshev_t scalar.
...
TEST(ReplWave288Pipeline, GraphStatsGeoImage) {
    Interpreter interp;
...
TEST(ReplWave288Pipeline, SpecialScalar) {
    Interpreter interp;
