...
- **Version:** 1.0.0 — Phase 10 (hardening) complete; profiling **complete** through Wave 228 (see [`CHANGELOG.md`](CHANGELOG.md) and [`docs/PERFORMANCE.md`](docs/PERFORMANCE.md))
