...
- **Version:** 1.0.0 — Phase 10 (hardening) complete; post-1.0 work continues via the wave process above (latest: Wave 224 in [`CHANGELOG.md`](CHANGELOG.md); **profiling complete**)
- **Tests:** **369** CTest suites, 100% passing (CUDA disabled in CI); ~91% line coverage (**90%** minimum enforced in CI)
