...
Write-Host "  [ ] 363 CTest suites passing"
...
Write-Host "  [ ] Packaging smoke (scripts/package_smoke.ps1 or scripts/package_smoke.sh)"
Write-Host ""
...
Write-Host "Packaging:     .\scripts\package_smoke.ps1 build-msvc install-smoke"
Write-Host ""
