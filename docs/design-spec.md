...
- **872 CTest suites, all passing** on Linux GCC 13 Release with CUDA off (the catalogue that `docs/RELEASE.md` gates on; other configurations enable or exclude different suites)
