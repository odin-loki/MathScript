...
QStringList repl_command_list() {
    return {
        ...
        QStringLiteral("fftshift"),
        QStringLiteral("ifftshift"),
        QStringLiteral("fftfreq"),
        QStringLiteral("rfftfreq"),
        ...
        QStringLiteral("numthy_cornacchia"),
        ...
        QStringLiteral("numthy_is_carmichael"),
        ...
        QStringLiteral("geo_upper_hull"),
        QStringLiteral("geo_lower_hull"),
        ...
        QStringLiteral("geo_kdtree_3d_knn"),
        QStringLiteral("geo_kdtree_3d_range"),
        QStringLiteral("geo_bezier_subdivide"),
