...
Result<Matrix<double>> handle_ml_qda_fit(Interpreter& interp, const MatrixCallAssign& assign) {
...
void ms_register_matrix_call_ml_qda_fit() {
    register_matrix_call("ml_qda_fit", &handle_ml_qda_fit);
}
