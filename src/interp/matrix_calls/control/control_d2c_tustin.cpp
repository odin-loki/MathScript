...
Result<Matrix<double>> handle_control_d2c_tustin(Interpreter& interp, const MatrixCallAssign& assign) {
...
void ms_register_matrix_call_control_d2c_tustin() {
    register_matrix_call("control_d2c_tustin", &handle_control_d2c_tustin);
}
