...
Result<Matrix<double>> handle_control_c2d(Interpreter& interp, const MatrixCallAssign& assign) {
...
void ms_register_matrix_call_control_c2d() {
    register_matrix_call("control_c2d", &handle_control_c2d);
}
