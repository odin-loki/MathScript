...
Result<Matrix<double>> handle_control_c2d_tf_tustin(Interpreter& interp, const MatrixCallAssign& assign) {
...
void ms_register_matrix_call_control_c2d_tf_tustin() {
    register_matrix_call("control_c2d_tf_tustin", &handle_control_c2d_tf_tustin);
}
