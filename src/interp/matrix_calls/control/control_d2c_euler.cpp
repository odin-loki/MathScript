...
Result<Matrix<double>> handle_control_d2c_euler(Interpreter& interp, const MatrixCallAssign& assign) {
...
void ms_register_matrix_call_control_d2c_euler() {
    register_matrix_call("control_d2c_euler", &handle_control_d2c_euler);
}
