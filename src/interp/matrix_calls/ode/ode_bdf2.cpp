...
Result<Matrix<double>> handle_ode_bdf2(Interpreter& interp, const MatrixCallAssign& assign) {
...
void ms_register_matrix_call_ode_bdf2() {
    register_matrix_call("ode_bdf2", &handle_ode_bdf2);
}
