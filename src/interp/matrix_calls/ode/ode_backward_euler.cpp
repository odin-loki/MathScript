...
Result<Matrix<double>> handle_ode_backward_euler(Interpreter& interp, const MatrixCallAssign& assign) {
...
void ms_register_matrix_call_ode_backward_euler() {
    register_matrix_call("ode_backward_euler", &handle_ode_backward_euler);
}
