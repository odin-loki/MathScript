...
Result<Matrix<double>> handle_geo_bezier_eval(Interpreter& interp, const MatrixCallAssign& assign) {
...
void ms_register_matrix_call_geo_bezier_eval() {
    register_matrix_call("geo_bezier_eval", &handle_geo_bezier_eval);
}
