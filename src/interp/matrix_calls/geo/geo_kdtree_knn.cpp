...
Result<Matrix<double>> handle_geo_kdtree_knn(Interpreter& interp, const MatrixCallAssign& assign) {
...
void ms_register_matrix_call_geo_kdtree_knn() {
    register_matrix_call("geo_kdtree_knn", &handle_geo_kdtree_knn);
}
