...
Result<Matrix<double>> handle_imopen(Interpreter& interp, const MatrixCallAssign& assign) {
    ...
    if ((assign.callee == "imdilate" || assign.callee == "imerode" ||
        ...
        // imopen(ones(512,512), 4999) is 6.5e12 of them, about a day.
...
void ms_register_matrix_call_imopen() {
    register_matrix_call("imopen", &handle_imopen);
}
