...
Result<Matrix<double>> handle_quantum_schrodinger_final(Interpreter& interp, const MatrixCallAssign& assign) {
    ...
    if (assign.callee == "quantum_schrodinger_final" && assign.args.size() == 5) {
...
void ms_register_matrix_call_quantum_schrodinger_final() {
    register_matrix_call("quantum_schrodinger_final", &handle_quantum_schrodinger_final);
}
