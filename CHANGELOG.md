...
- Tests: more no-assignment REPL `execute("fn(...)")` printers (special/numthy/stats/graph/quantum/finance/poly/fft/geo/sym/ode/pde/cfd) plus extra symbolic CAS/dsolve unit cases.
