...
- ASan CI: `detect_leaks=0` so arena/pool tests do not fail the job on process-exit leaks; overflows still fail. Three-blob GMM checks separated finite centers.
